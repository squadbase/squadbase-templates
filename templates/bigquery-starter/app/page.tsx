...
export default function Home() {
  return (
    <div className="flex flex-col gap-8 py-6 md:py-8 px-4 md:px-6 lg:px-8">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-2xl bg-primary p-8 md:p-12 lg:p-16 text-primary-foreground shadow-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-primary-foreground/90 mt-1">
                Explore and analyze your BigQuery data
              </p>
            </div>
          </div>

          <p className="text-base md:text-lg text-primary-foreground/80 max-w-2xl leading-relaxed">
            Connect to your BigQuery datasets and explore tables, views, and data structures. Get insights into your data with an intuitive interface designed for data exploration and dashboard creation.
          </p>
        </div>
