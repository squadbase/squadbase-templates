...
export function CategoryMonthHeatmap({ data }: CategoryMonthHeatmapProps) {
  ...
  const option: EChartsOption = {
    tooltip: {
      ...
      formatter: (params: unknown) => {
        ...
        const cat =
          CATEGORY_LIST[CATEGORY_LIST.length - 1 - p.value[1]]
        ...
        return [
          ...
          `Revenue: ${formatCurrency(cell.revenue, { short: true })}`,
        ].join("<br/>")
      },
    },
  ...
  return (
    <DashboardCardPreset
      title="Category × Month YoY Heatmap"
      description="Year-over-year growth heatmap by category and month — spot outliers and seasonal swings"
    >
