import { TrendingUp, Trophy, Ticket } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/campaign-effectiveness-test-derive-insights"

const iconMap = {
  "headline-lift": TrendingUp,
  "top-roi": Trophy,
  "coupon-quality": Ticket,
} as const
