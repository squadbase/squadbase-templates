...
import { deriveInsights } from "@/lib/demand-forecast-vs-actual-derive-insights"

const iconMap = {
  "accuracy-trend": TrendingDown,
  "worst-product": AlertTriangle,
  "fill-vs-stockout": ShieldCheck,
} as const
