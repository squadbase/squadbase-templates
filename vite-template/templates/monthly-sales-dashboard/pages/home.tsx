...
const kpiIcons = [DollarSign, Target, TrendingUp, Percent, PieChart] as const
...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>Monthly Sales Dashboard</PageShellTitle>
          <PageShellDescription>
            Executive reporting view — month-over-month trend, budget attainment, and segment contribution
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
