import { Trophy, UsersRound, GraduationCap } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/learning-progress-dashboard-derive-insights"

const iconMap = {
  "top-course": Trophy,
  "engagement-gap": UsersRound,
  "pass-rate": GraduationCap,
} as const
