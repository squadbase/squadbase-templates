import { ShieldAlert, Activity, LifeBuoy } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/churn-prediction-monitor-derive-insights"

const iconMap = {
  "critical-risk": ShieldAlert,
  "frequency-signal": Activity,
  "save-momentum": LifeBuoy,
} as const
