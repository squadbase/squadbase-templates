import { TrendingUp, GitBranch, AlertCircle } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/quote-to-order-conversion-derive-insights"

const iconMap = {
  "conversion-trend": TrendingUp,
  "weakest-step": GitBranch,
  "loss-driver": AlertCircle,
} as const
