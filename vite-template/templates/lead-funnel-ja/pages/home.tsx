...
const kpiIcons = [Users, Filter, CalendarCheck, TrendingUp, JapaneseYen] as const
...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>リードファネル</PageShellTitle>
          <PageShellDescription>
            ステージ別のリード件数推移、獲得チャネル別件数とCPL、ISメンバー別アポ件数ランキングを一画面で把握
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
