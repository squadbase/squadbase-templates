...
const kpiIcons = [JapaneseYen, PieChart, Cpu, ArrowRightLeft] as const
...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>AI／クラウドコスト分析</PageShellTitle>
          <PageShellDescription>
            サービス別月次クラウドコスト・AIモデル別トークンコスト・コスト上位リソースを横断的に可視化
          </PageShellDescription>
        </PageShellHeading>
        <PageShellSummary>
          <InsightCards />
