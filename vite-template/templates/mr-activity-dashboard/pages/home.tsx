...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>MR Activity Dashboard</PageShellTitle>
          <PageShellDescription>
            Visit volume, meeting rate, Rx share, and facility coverage — with MR ranking and uncovered facility follow-ups
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
