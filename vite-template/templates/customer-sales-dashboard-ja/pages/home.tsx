...
import { JapaneseYen, TrendingUp, Users, AlertTriangle } from "lucide-react"
...
const kpiIcons = [JapaneseYen, TrendingUp, Users, AlertTriangle] as const
...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>得意先別売上ダッシュボード</PageShellTitle>
          <PageShellDescription>
            営業/アカウントマネージャー向け — 得意先別売上・集中度・離反候補を一画面で把握
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
