...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>Task & Project Status Management</PageShellTitle>
          <PageShellDescription>
            Monitor task status across the team — open work, in-flight items, completions, and slipping due dates
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
