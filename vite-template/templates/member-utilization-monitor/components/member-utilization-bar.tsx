...
export function MemberUtilizationBar({ data }: MemberUtilizationBarProps) {
    ...
    tooltip: {
      ...
      formatter: (params: unknown) => {
        ...
        return [
          ...
          `Utilization: ${m.utilizationPct.toFixed(1)}%`,
          `Work: ${m.workHours}h / ${m.availableHours}h`,
          `Overtime: ${m.overtimeHours}h`,
        ].join("<br/>")
      },
    },
    grid: getBaseGrid(),
  ...
  return (
    <DashboardCardPreset
      ...
      description="Each member's monthly utilization with the healthy band (65–90%) drawn in"
    >
