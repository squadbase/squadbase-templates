...
import { PieChart, TrendingUp, Sparkles, JapaneseYen } from "lucide-react"
...
const kpiIcons = [PieChart, TrendingUp, Sparkles, JapaneseYen] as const
...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>商品カテゴリ別パフォーマンス</PageShellTitle>
          <PageShellDescription>
            各カテゴリの寄与・新商品の押上げ効果・YoY のばらつきを一覧表示
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
