...
const sideOptions = [
  ...
  { label: "Liabilities & Equity", value: "liability" },
]
...
export function BsCompositionChart({
  ...
  const option: EChartsOption = {
    ...
    series: [
      {
        name: side === "asset" ? "Assets" : "Liabilities & Equity",
        type: "pie",
        radius: ["48%", "72%"],
        center: ["50%", "44%"],
  ...
  return (
    <DashboardCardPreset
      title="B/S Composition"
      description="Toggle between Assets and Liabilities & Equity to review composition"
      actions={
        <SegmentedControl
          size="sm"
          options={sideOptions}
