...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>Equipment Maintenance Dashboard</PageShellTitle>
          <PageShellDescription>
            Plant maintenance read-out: availability, MTBF/MTTR, failure trend, and preventive-maintenance status
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
