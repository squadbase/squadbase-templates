import { ShieldAlert, ClipboardList, TrendingDown } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/equipment-maintenance-dashboard-derive-insights"

const iconMap = {
  "availability-risk": ShieldAlert,
  "pm-backlog": ClipboardList,
  "failure-trend": TrendingDown,
} as const
