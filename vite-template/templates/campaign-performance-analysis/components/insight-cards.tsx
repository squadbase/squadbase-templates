import { Trophy, GraduationCap, Gauge } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/campaign-performance-analysis-derive-insights"

const iconMap = {
  "top-roas": Trophy,
  "learning-phase": GraduationCap,
  "budget-pacing": Gauge,
} as const
