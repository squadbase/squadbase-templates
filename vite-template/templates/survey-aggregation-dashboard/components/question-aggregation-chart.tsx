...
export function QuestionAggregationChart({
    ...
    tooltip: {
      ...
      formatter: (params: unknown): string => {
        ...
        return [
          ...
          `Average score: ${formatScore(q.avgScore)} / 5`,
          `Responses: ${q.responseCount.toLocaleString("en-US")}`,
          `Distribution (1-5): ${dist}`,
        ].join("<br/>")
      },
    },
    grid: {
  ...
  return (
    <DashboardCardPreset
      ...
      description="Average score per question (1-5 scale), sorted from lowest to highest"
    >
