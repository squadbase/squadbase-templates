...
export default function HomePage() {
  ...
  const finalCustomers =
    filters.segment && filters.segment !== "all"
      ? filteredCustomers.filter((c) => c.segment === filters.segment)
      : filteredCustomers
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>Churn Prediction Monitor</PageShellTitle>
          <PageShellDescription>
            Spot at-risk customers before they churn — score-ranked list, frequency-decline signals, and monthly churn-rate trend
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
