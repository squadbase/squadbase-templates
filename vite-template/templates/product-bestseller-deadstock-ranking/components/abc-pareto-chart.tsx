...
import type { ParetoPoint } from "@/types/product-bestseller-deadstock-ranking"
...
export function AbcParetoChart({ data }: AbcParetoChartProps) {
  const xLabels = data.map((d) => d.productId)
    ...
    tooltip: {
      ...
      formatter: (params: unknown) => {
        ...
        return [
          ...
          `<span style="color:#737373">${point.productId} · Class ${point.abcClass}</span>`,
  ...
  return (
    <DashboardCardPreset
      ...
      description="Sorted product revenue with cumulative % overlay — A class drives the bulk of revenue"
    >
