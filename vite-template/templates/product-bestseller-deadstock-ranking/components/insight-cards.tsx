import { Layers, AlertOctagon, Sparkles } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/product-bestseller-deadstock-ranking-derive-insights"

const iconMap = {
  concentration: Layers,
  deadstock: AlertOctagon,
  rising: Sparkles,
} as const
