...
import type { WaterfallStep } from "@/types/pl-dashboard"

interface PlWaterfallChartProps {
  data: WaterfallStep[]
}

// ECharts requires concrete colors here. Values track the chart theme palette.
const COLOR = {
  revenue: "#10b981",
  subtotal: "#3b82f6",
  cost: "#ef4444",
...
export function PlWaterfallChart({ data }: PlWaterfallChartProps) {
  ...
  return (
    <DashboardCardPreset
      title="P&L Waterfall"
      description="Latest-month walk from revenue down to ordinary income"
    >
