...
import { deriveInsights } from "@/lib/player-performance-analysis-derive-insights"

const iconMap = {
  "workload-leader": Activity,
  "condition-watch": ShieldAlert,
  "match-momentum": TrendingUp,
} as const
