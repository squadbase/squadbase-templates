import { ShieldAlert, CalendarOff, TrendingUp } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/attendance-dashboard-derive-insights"

const iconMap = {
  "overload-risk": ShieldAlert,
  "leave-gap": CalendarOff,
  "overtime-trend": TrendingUp,
} as const
