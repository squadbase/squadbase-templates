...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>Quality Defect Tracking</PageShellTitle>
          <PageShellDescription>
            Pinpoint the few causes driving most defects, the hottest line × cause cells, and whether the monthly trend is in control
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
