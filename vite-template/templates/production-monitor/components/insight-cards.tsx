import { Gauge, Factory, ShieldCheck } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/production-monitor-derive-insights"

const iconMap = {
  "attainment-snapshot": Gauge,
  "line-spotlight": Factory,
  "defect-control": ShieldCheck,
} as const
