import { Filter, MonitorSmartphone, LogOut } from "lucide-react"
import { PageShellSummaryCard } from "@/components/common/page-shell"
import { deriveInsights } from "@/lib/ec-conversion-funnel-derive-insights"

const iconMap = {
  "weakest-step": Filter,
  "device-gap": MonitorSmartphone,
  "top-exit": LogOut,
} as const
