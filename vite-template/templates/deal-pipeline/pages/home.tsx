...
import { Briefcase, DollarSign, Scale, TrendingUp } from "lucide-react"
...
const kpiIcons = [Briefcase, DollarSign, Scale, TrendingUp] as const
...
export default function HomePage() {
  ...
  return (
    <PageShell>
      <PageShellHeader>
        <PageShellHeading>
          <PageShellTitle>Deal Pipeline</PageShellTitle>
          <PageShellDescription>
            Track active deals through the sales funnel, at-risk follow-ups, and forecasted bookings
          </PageShellDescription>
        </PageShellHeading>
        <PageShellHeaderEnd>
          <DateRangePicker
